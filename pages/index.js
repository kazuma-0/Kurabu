      ...
      <Center className="flex flex-col-reverse items-start !justify-between lg:flex-row h-[calc(100vh_-_7rem)]">
        <div className={"flex-[.6]"}>
          ...
          <p className="text-lg pt-3 text-justify max-w-lg font-sofia">
            The department of Computer Science and Engineering in the Faculty of
            Engineering has a Research and development club called The Metaverse
            Club. The Karpagam Academy of Higher Education students are
            passionate about innovation and technology in Artificial
            Intelligence and Machine learning, Blockchain, Augmented reality and
            Virtual reality, and Mobile and Web application development. The
            metaverse club aims to brainstorm and explore initiatives pertinent
