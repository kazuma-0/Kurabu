...
import {Button, Center, FormControl, FormHelperText, FormLabel, Input, useToast,} from "@chakra-ui/react";
...
function Register() {
    ...
    return (
        <div className={"h-cover relative"}>
            <UserForm onSubmit={handleSubmit} onChange={dispatcher} formState={formState} onClick={(e) => {
                e.preventDefault();
                reconnect();
            }} loading={loadingSignUp} onClick1={signUp}/>
            <AnimatePresence>
                {!valid && (
                    <Invite
                        value={code}
