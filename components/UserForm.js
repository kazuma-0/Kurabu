import {Button, Center, FormControl, FormHelperText, FormLabel, Input, Select} from "@chakra-ui/react";
import {IconTrash} from "@tabler/icons";

function UserForm(props) {
    return <div className="h-full max-w-3xl mx-auto">
        <Center className={"h-full"}>
            ...
            >
                ...
                <div className={"py-2 flex justify-between"}>
                    ...
                    {props.deleteUser && <Button leftIcon={<IconTrash/>} onClick={props.deleteUser} colorScheme={"red"}>Delete
                        user</Button>}
                </div>
            </form>
        </Center>
