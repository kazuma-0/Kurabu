            ...
            <div>
              <FormControl>
                ...
                <Input
                  ...
                  type={"text"}
                ></Input>
                <FormHelperText>Upload image in an online hosting service and paste the link here. Recommended: <a href={"https://catbox.moe"} target={"_blank"} rel="noreferrer">catbox</a></FormHelperText>
                <div hidden={!props.state.image_url.startsWith("https://")} className="w-full h-60 bg-center bg-cover my-3 rounded shadow" style={{backgroundImage: `url(${props.state.image_url})`}}>
                </div>
                ...
                <Input
                  ...
                  type={"text"}
                ></Input>
                <FormHelperText>Separate each tag using , Maximum 5 tags</FormHelperText>
